...
Nêu tên khái niệm/vấn đề trước, giải thích cụ thể sau vài đoạn, tạo tension.

**Công thức:**
```
Nêu tên/thuật ngữ (treo) → 2-3 đoạn tình huống/bối cảnh khác
    → Quay lại giải thích: "Vấn đề X đó là..."
```

**Ví dụ:**
```
✅ Đoạn 2: "Đó là vấn đề 'nguồn lực con người'."
   Đoạn 3-4: Kể chi tiết kinh nghiệm xây dựng vs tài chính
   Đoạn 5: "Vấn đề 'nguồn lực con người' đó là nằm ở 'lĩnh vực chuyên môn'."
```

**Cấm:** Treo quá lâu (>4 đoạn) hoặc không giải thích. Người đọc quên = thất bại.
...
✅ Câu hỏi provocative, call to action, hoặc final insight crystallized
```

| Kiểu | Khi nào | Ví dụ |
|------|---------|-------|
| Câu hỏi chiến lược | Phân tích chuyên sâu | "Câu hỏi lớn nhất không phải NIM chạm đáy chưa, mà là ngân hàng nào đủ năng lực giữ NIM ổn định" |
