...
## Quy tắc trình bày nâng cao (Formal Navy)

Áp dụng cho văn bản đề xuất cấp chiến lược (trình Ban Giám đốc, Hội đồng).

### Viết hoa heading

- **Quy tắc tiếng Việt:** Chỉ viết hoa chữ cái đầu câu và tên riêng (UNESCO, Viettel, BCG...).
- **Sai:** "Khung Năng Lực AI Quốc Tế" → **Đúng:** "Khung năng lực AI quốc tế"
- **Ngoại lệ:** Tên tổ chức, tên luật, tên viết tắt giữ nguyên: "Bộ Khoa học và Công nghệ", "Diễn đàn Kinh tế Thế giới"

### Phân cấp màu sắc heading

| Cấp | Kiểu | Màu | Ví dụ |
|---|---|---|---|
| H1 (# cấp) | Bold, viền dưới đỏ | Đỏ đậm `#C00000` | "Phần 1: Phân tích và đánh giá nguyên liệu" |
| H2 (## cấp) | Bold | Navy `#1F3864` | "1. Phân tích 8 nền tảng quốc tế" |
| H3 (** cấp) | Bold + Italic | Đen body `#202020` | "1.1. Khung năng lực AI của UNESCO" |

### Intro paragraph

- Đoạn văn đầu tiên ngay sau H1 (mở đầu mỗi Phần/Chương) → **Italic, Navy đậm `#244061`**
- Mục đích: Tạo điểm nhấn thị giác, giúp người đọc nắm ngay tinh thần của Phần trước khi đi vào chi tiết.
- Trong MD: Đánh dấu bằng `*nội dung*` (italic).

### Items liệt kê (a)(b)(c)

- Khi liệt kê nhiều hạng mục (ví dụ: các bước, các mốc, các tầng), **tách mỗi item thành 1 dòng riêng**.
- Từ tiếng Anh trong ngoặc → **italic xám `#595959`**.
- Trong MD: Viết mỗi item bắt đầu bằng `(a) `, `(b) `, `(c) `.

### Keyword nhấn mạnh

- **Bold inline** trong body text → **Bold + Italic** (kiểu nhấn mạnh kỹ năng), không tô navy.
- Keyword đặc biệt như "Giải pháp" → Bold Navy `#1F3864` riêng run, phần sau là text thường.

### Quote card

- Nền xám nhạt `#F0F0F0` + viền trái navy `#1F3864` (18pt, space 12).
- Chữ italic xám `#595959`.
- **Căn đúng lề body text**, không thụt indent.
